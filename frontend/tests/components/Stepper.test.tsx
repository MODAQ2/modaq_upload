...
describe('Stepper', () => {
  ...
  it('allows clicking completed steps 1 and 2 when not uploading', async () => {
    ...
    render(<Stepper currentStep={3} onStepClick={onStepClick} isUploading={false} />);
  ...
  it('disables clicking completed steps when uploading', async () => {
    ...
    render(<Stepper currentStep={3} onStepClick={onStepClick} isUploading={true} />);
  ...
  it('does not allow clicking future steps', async () => {
    ...
    render(<Stepper currentStep={1} onStepClick={onStepClick} />);
  ...
  it('does not allow clicking the active step', async () => {
    ...
    render(<Stepper currentStep={2} onStepClick={onStepClick} />);
