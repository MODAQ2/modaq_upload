...
export default function ScanProgressModal({
  ...
  return (
    <>
      {/* biome-ignore lint/a11y/noStaticElementInteractions: backdrop overlay — Escape handled by document keydown listener above */}
      <div
        ref={backdropRef}
        role="presentation"
          ...
          <div className="p-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Searching for Data Files and checking upload status...
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800">
                ...
                minutes. Each file is checked against the upload cache to determine if it's already
                been uploaded to S3.
              </p>
            </div>
