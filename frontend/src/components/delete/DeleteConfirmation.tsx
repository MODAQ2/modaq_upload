    ...
    <div className="max-w-lg mx-auto space-y-6">
      ...
      <AlertBanner
        ...
        message={
          <>
            ...
            <strong>
              {totalFiles} local file{totalFiles !== 1 ? 's' : ''}
            </strong>{' '}
        ...
        message={
          <>
            ...
            <Link
              ...
              title="Browse uploaded files in cloud storage"
            >
              cloud storage
            </Link>{' '}
            remain safe and unchanged. Each file is verified against the cloud upload before
            removal.
          </>
        }
      />
      ...
      <label className="flex items-start gap-3 cursor-pointer">
        ...
        <span className="text-sm text-gray-700">
          I understand that cleared files cannot be recovered from this drive and that the cloud
          uploads have been verified.
        </span>
      </label>
